    ...
    <div className="dashboard-container">
        ...
        <header className="header">
            <div className="profile-section">
                <div className="avatar-circle" onClick={()=>navigate('/donor/profile')}>
                ...
                <div className="user-meta">
                    ...
                    <p className="blood-type">{user?.blood_type}</p>
                </div>
            </div>
        ...
        <main className="content">
            ...
            <div className="stats-grid">
                <div className="stat-card red-bg">
                    ...
                    <p className="value">{new Date(lastDonationDate).toLocaleDateString()}</p>
                </div>
                <div className="stat-card white-bg">
                    <p className="label muted">Total Donations</p>
                    <p className="value dark">{totalDonations}</p>
                </div>
            </div>

            <div className="feature-grid">
                
                <div className="grid-item" onClick={()=>navigate('/donor/notifications')}>
                ...
                <div className="grid-item" onClick={()=>navigate('/donor/awards')}>
                ...
                <div className="grid-item" onClick={()=>navigate('/donor/donations')}>
                ...
                <div className="grid-item" onClick={()=>navigate('/donor/medical_notes')}>
            ...
            <div className="cta-banner" onClick={()=>navigate('/donor/notifications')}>
