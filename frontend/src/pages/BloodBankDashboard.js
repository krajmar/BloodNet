    ...
    <div className="dashboard-container">
        ...
        <header className="header">
            <div className="profile-section">
                <div className="avatar-circle" onClick={()=>navigate('/bloodbank/profile')}>
        ...
        <main className="content">
            ...
            <div className="feature-grid">
                ...
                <div className="grid-item" onClick={()=>navigate('/bloodbank/notifications')}>
                ...
                <div className="grid-item" onClick={()=>navigate('/bloodbank/awards')}>
                ...
                <div className="grid-item" onClick={()=>navigate('/bloodbank/donations')}>
                    <div className="icon-wrapper amber-tint">
                ...
                <div className="grid-item" onClick={()=>navigate('/bloodbank/blood_inventories')}>
